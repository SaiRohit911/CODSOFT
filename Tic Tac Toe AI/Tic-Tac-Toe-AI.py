...
class TIC_TAC_TOE_AI:
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI", bg="#141414", fg="#00FF00", font=("Arial", 25, "bold","italic")).place(x=110, y=10)
        ...
        self.machine_first_control = Button(self.make_canvas, text="Machine vs Human", font=("Georgia", 14, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#00FFFF", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=15, y=380)

        self.human_first_control = Button(self.make_canvas, text="Human vs Machine", font=("Georgia", 14, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#00FFFF", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=240, y=380)

        self.reset_btn = Button(self.make_canvas, text="Reset", font=("Algerian", 15, "bold", "italic"), bg="#262626", activebackground="#262626", disabledforeground="grey", fg="#9d9dff", relief=RAISED, bd=3, command=self.reset, state=DISABLED)
